function bootstrapAICCont=fitDisModelIterHPC_indiv_rate_2seg(x,yActual,allBreaks,yLab,xLab,statLimits,statSpacing,...
...
%save(['/home/svu/lsitpk/HPC_PK/data/em/gradient/shuffled/surrogate2seg_' MonkyInitial '_' regionStr '_' folderName '_' num2str(maxiters) 'i_' uniqueID '.mat'],'bootstrapR2Cont');
save(['/hpctmp/lsitpk/noncompiled/surrogate2seg_' MonkyInitial '_' regionStr '_' folderName '_' num2str(maxiters) 'i_' uniqueID '.mat'],'bootstrapR2Cont');
end
