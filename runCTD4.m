function performance = runCTD4(datasets,m,st,sessions,trialLabel,trials,...
...
if strcmp(trialLabel,'Reward') || strcmp(trialLabel,'reward')
    trainingLabel = randsample([0 1],nTrainingTrials,true);
    testingLabel = randsample([0 1],test_tr,true);
elseif strcmp(Test,'Correct') & strcmp(Test,'Reward')==0  || strcmp(Test,'correct') & strcmp(Test,'Reward')==0
...
elseif strcmp(Test,'Error') & strcmp(Test,'Reward')==0 || strcmp(Test,'error') & strcmp(Test,'Reward')==0
    trainingLabel = randsample([2 3 5 6],nTrainingTrials,true);
    testingLabel = randsample([2 3 5 6],test_tr,true);
else
    trainingLabel = randsample([2 3 5 6],nTrainingTrials,true);
